...
from pytracking.evaluation.vot2016dataset import VOT2016Dataset
...
from pytracking.evaluation.davisdataset import DAVISDataset
...
def main():
    ...
    run_tracker(tracker_name='ecoseg', tracker_param='default', run_id=None, dataset_name='vot2016',
                sequence='basketball', debug=1, threads=0)
